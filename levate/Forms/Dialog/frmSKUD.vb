...
Public Class frmSKUD
            ...
            Case "frmStockR"
                With frmStockR
                    If DialogText = "txtCodeFrom" Then
                        .txtCodeFrom.Text = ListView1.SelectedItems.Item(0).SubItems.Item(1).Text
                    Else
                        .txtCodeTo.Text = ListView1.SelectedItems.Item(0).SubItems.Item(1).Text
                    End If
                    Me.Close()
                End With
            Case "frmStockLocationR"
    ...
    Private Sub frmSKUD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        With ListView1
            .Clear()
            .View = View.Details
