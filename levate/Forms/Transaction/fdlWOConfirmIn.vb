...
Public Class fdlWOConfirmIn
    ...
    Private Sub fdlWOConfirmIn_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        With ListView1
            .Clear()
            .View = View.Details
