...
Public Class fdlPchCodeTo
    ...
    Private Sub Cancel_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cancel_Button.Click
        ...
        Me.Close()
    End Sub
    Private Sub fdlPchCodeTo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        With ListView1
            .Clear()
            .View = View.Details
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        Select Case m_FrmCallerId
            ...
            Case "rptPORecap"
                With rptPORecap
                    .PchCodeIdTo = LeftSplitUF(ListView1.SelectedItems.Item(0).Tag)
                    .PchCodeTo = ListView1.SelectedItems.Item(0).SubItems.Item(0).Text
                End With
            Case "rptPOList"
                With rptPOList
                    .PchCodeIdTo = LeftSplitUF(ListView1.SelectedItems.Item(0).Tag)
