...
Public Class frmBankPaymentPostList
    ...
    Private Sub frmBankPaymentPostList_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        m_BankAccountId = GetSysAccount("bank")
        m_ExpIncAccountId = GetSysAccount("expense")
        ...
        If ListView1.CheckedItems.Count > 0 Then
            For i = 1 To ListView1.Items.Count
                If ListView1.Items(i - 1).Checked = True Then
                    cmd = New SqlCommand("usp_tr_bank_trans_pay_POST", cn)
