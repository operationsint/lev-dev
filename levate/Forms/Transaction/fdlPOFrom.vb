...
Public Class fdlPOFrom
    ...
    Private Sub fdlPOFrom_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        With ListView1
            .Clear()
            .View = View.Details
            .Columns.Add("Purchase Order No.", 250)
            .Columns.Add("sku_category", 0)
            .Columns.Add("cat_remarks", 0)
        End With

        cmd = New SqlCommand("sp_tr_po_rpt_SEL", cn)
