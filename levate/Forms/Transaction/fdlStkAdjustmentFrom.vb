...
Public Class fdlStkAdjustmentFrom
    ...
    Private Sub fdlStkAdjustmentFrom_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        With ListView1
            .Clear()
            .View = View.Details
            .Columns.Add("Stock Adjustment Type.", 0)
            .Columns.Add("Stock Adjustment No.", 250)
            .Columns.Add("cat_remarks", 0)
        End With

        cmd = New SqlCommand("sp_tr_stkadj_rpt_SEL", cn)
        ...
        Select Case m_FrmCallerId
            Case "rptStkAdjustment"
                With rptStkAdjustment
                    .NoFrom = ListView1.SelectedItems.Item(0).SubItems.Item(1).Text
                End With
        End Select
        Me.Close()
    End Sub
    ...
    Private Sub txtFilter_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtFilter.KeyPress
        If e.KeyChar = Microsoft.VisualBasic.ChrW(Keys.Return) Then
            fdlStkAdjustmentFrom_Load(sender, e)
        End If
    End Sub
End Class