...
Public Class frmStockAdjPostList
        ...
        If ListView1.CheckedItems.Count > 0 Then
            For i = 1 To ListView1.Items.Count
                If ListView1.Items(i - 1).Checked = True Then
                    If ListView1.Items(i - 1).SubItems.Item(3).Text = "STCST" Then

                        cmd = New SqlCommand("usp_tr_stock_cost_adj_POST", cn)
                        cmd.CommandType = CommandType.StoredProcedure

                        Dim prm1 As SqlParameter = cmd.Parameters.Add("@stock_cost_adj_id", SqlDbType.Int, 255)
                        prm1.Value = 0
                        Dim prm2 As SqlParameter = cmd.Parameters.Add("@stock_cost_adj_no", SqlDbType.NVarChar)
    ...
    Private Sub btnFilter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFilter.Click
        With ListView1
            ...
            .Columns.Add("TransType", 0)
        End With

        cmd = New SqlCommand("usp_tr_stock_adj_POST_SEL", cn)
        cmd.CommandType = CommandType.StoredProcedure

        Dim prm1 As SqlParameter = cmd.Parameters.Add("@trans_type", SqlDbType.NVarChar, 50)
        prm1.Value = "STADJ"
        Dim prm5 As SqlParameter = cmd.Parameters.Add("@trans_type2", SqlDbType.NVarChar, 50)
        prm5.Value = "STPRO"
        Dim prm7 As SqlParameter = cmd.Parameters.Add("@trans_type3", SqlDbType.NVarChar, 50)
        prm7.Value = "STCST"
        ...
        While myReader.Read
            ...
            lvItem.SubItems.Add(myReader.Item(1)) 'Transtype
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        If ListView1.SelectedItems.Item(0).SubItems.Item(3).Text = "STCST" Then
        ...
        Else
            If Not isDeletedRecord("usp_tr_stock_adj_SEL", "stock_adj_id", LeftSplitUF(ListView1.SelectedItems.Item(0).Tag), Me.Text) = False Then
                btnFilter_Click(sender, e)
            ElseIf Not Application.OpenForms().OfType(Of frmStockAdj).Any Then
                With frmStockAdj
