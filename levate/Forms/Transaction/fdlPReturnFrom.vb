...
Public Class fdlPReturnFrom
    ...
    Private Sub Cancel_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cancel_Button.Click
        ...
        Me.Close()
    End Sub
    Private Sub fdlPReturnFrom_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        With ListView1
            .Clear()
            .View = View.Details
            .Columns.Add("Purchase Return No.", 250)
            .Columns.Add("sku_category", 0)
            .Columns.Add("cat_remarks", 0)
        End With

        cmd = New SqlCommand("sp_tr_preturn_rpt_SEL", cn)
