...
Public Class frmPInvoicePostList
    ...
    Private Sub btnPost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPost.Click
        ...
        If m_StockAccountId = 0 Or m_ExpenseAccountId = 0 Or m_TaxAccountId = 0 Or m_APAccountId = 0 Or m_SuspenseAccountId = 0 Then
        ...
        If ListView1.CheckedItems.Count > 0 Then
            For i = 1 To ListView1.Items.Count
                If ListView1.Items(i - 1).Checked = True Then
                    cmd = New SqlCommand("usp_tr_pinvoice_POST", cn)
    ...
    Private Sub btnFilter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFilter.Click
        ...
        cmd = New SqlCommand("usp_tr_pinvoice_POST_SEL", cn)
        cmd.CommandType = CommandType.StoredProcedure
