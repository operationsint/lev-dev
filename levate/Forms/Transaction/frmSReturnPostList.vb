...
Public Class frmSReturnPostList
    ...
    Private Sub btnPost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPost.Click
        ...
        If m_ARAccountId = 0 Or m_RevenueAccountId = 0 Or m_TaxAccountId = 0 Or m_SuspenseAccountId = 0 Then
        ...
        If ListView1.CheckedItems.Count > 0 Then
            For i = 1 To ListView1.Items.Count
                If ListView1.Items(i - 1).Checked = True Then
                    cmd = New SqlCommand("usp_tr_sinvoice_RET_POST", cn)
                    ...
                    Dim prm12 As SqlParameter = cmd.Parameters.Add("@cos_account_id", SqlDbType.Int)
                    prm12.Value = m_CoSAccountId
                    Dim prm13 As SqlParameter = cmd.Parameters.Add("@revenue_account_id", SqlDbType.Int)
                    prm13.Value = m_RevenueAccountId
                    Dim prm14 As SqlParameter = cmd.Parameters.Add("@ar_account_id", SqlDbType.Int)
                    prm14.Value = m_ARAccountId
                    Dim prm15 As SqlParameter = cmd.Parameters.Add("@tax_account_id", SqlDbType.Int)
                    prm15.Value = m_TaxAccountId
                    Dim prm16 As SqlParameter = cmd.Parameters.Add("@suspense_account_id", SqlDbType.Int)
                    prm16.Value = m_SuspenseAccountId
