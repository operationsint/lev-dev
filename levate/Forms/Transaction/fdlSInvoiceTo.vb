...
Public Class fdlSInvoiceTo
    ...
    Private Sub fdlSInvoiceTo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        With ListView1
            .Clear()
            .View = View.Details
