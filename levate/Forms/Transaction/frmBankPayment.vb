...
Public Class frmBankPayment
    ...
    Private Sub frmBankPayment_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Sub clear_lvw()
        With ListView1
            ...
            .Columns.Add("Bank Payment Description", 370)
    ...
    Private Sub btnExpinc_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExpinc.Click
        ...
        NewFormDialog.fdlExpenseMode = 2 'Both Income & Expense
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If CDbl(txtTotal.Text) = 0 Then
            MsgBox("Warning,Bank Payment total is 0 !", vbInformation, Me.Text)
        End If
        Try
        ...
        Try
            If m_BankTransId = 0 Then
                If txtBankTransNo.Text = "" Then
                    txtBankTransNo.Text = GetSysNumber("bank_payment", Now.Date)
                    isGetNum = True
                Else
                    isGetNum = False
                End If
            ...
            If m_BankTransId = 0 Then
                ...
                m_BankTransId = 1
                cn.Close()
                If isGetNum = True Then UpdSysNumber("bank_payment")
                txtBankTransNo.ReadOnly = True
            Else
                cn.Open()
                cmd.ExecuteReader()
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        DA.Fill(DS, "Bank_Payment")

        Dim strReportPath As String = Application.StartupPath & "\Reports\RPT_Bank_Payment_Form.rpt"
        ...
        NewMDIChild.Text = "Bank Payment"
        NewMDIChild.Show()

        cr.Load(strReportPath)
        cr.SetDataSource(DS.Tables("Bank_Payment"))
        With NewMDIChild
    ...
    Sub autoRefresh()
        If Application.OpenForms().OfType(Of frmBankPaymentList).Any Then
            Call frmBankPaymentList.frmBankPaymentListShow(Nothing, EventArgs.Empty)
        End If
    End Sub
