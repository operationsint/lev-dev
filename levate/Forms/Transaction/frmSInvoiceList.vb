...
Public Class frmSInvoiceList
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        frmSInvoice.SInvoiceId = 0
        frmSInvoice.MdiParent = frmMAIN
        frmSInvoice.WindowState = FormWindowState.Maximized
        frmSInvoice.Show()
    End Sub

    Private Sub frmSInvoiceList_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Add item cmbStatus
    ...
    'Autorefresh---Hendra
    Public Sub frmSInvoiceListShow(ByVal sender As System.Object, ByVal e As System.EventArgs)
        btnFilter_Click(sender, e)
    End Sub
End Class