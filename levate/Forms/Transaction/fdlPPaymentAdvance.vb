...
Public Class fdlPPaymentAdvance
                    ...
                    Try
                        For i = 1 To ListView1.Items.Count
                            If ListView1.Items(i - 1).Checked = True Then
                                ...
                                prm2.Value = .SId
                                Dim prm3 As SqlParameter = cmd.Parameters.Add("@ppayment_advance_id", SqlDbType.Int, 255)
                                ...
                                Dim prm5 As SqlParameter = cmd.Parameters.Add("@ppayment_previous_advance", SqlDbType.Money)
    ...
    Private Sub fdlPPaymentAdvance_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        With ListView1
            .Clear()
            .View = View.Details
            ...
            .Columns.Add("sum_ppayment_advance", 0, HorizontalAlignment.Right)
        ...
        prm2.Value = frmPPayment.CurrId
        Dim prm3 As SqlParameter = cmd.Parameters.Add("@is_payment_advance", SqlDbType.Bit)
        prm3.Value = 1
        ...
        While myReader.Read
            ...
            lvItem.SubItems.Add(myReader.Item(2)) 'ppayment_date
            lvItem.SubItems.Add(myReader.GetInt32(11)) 'curr_id
            lvItem.SubItems.Add(myReader.GetString(12)) 'currency
            lvItem.SubItems.Add(FormatNumber(myReader.Item(13))) 'curr_rate
            lvItem.SubItems.Add(FormatNumber(myReader.Item(18))) 'total_paid
            lvItem.SubItems.Add(FormatNumber(myReader.Item(22))) 'sum_ppayment_advance
    ...
    Private Sub txtFilter_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If e.KeyChar = Microsoft.VisualBasic.ChrW(Keys.Return) Then
            fdlPPaymentAdvance_Load(sender, e)
        End If
    End Sub
