...
Public Class fdlSDeliveryFrom
    ...
    Private Sub fdlSDeliveryFrom_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        With ListView1
            .Clear()
            .View = View.Details
            .Columns.Add("Sales Delivery No.", 250)
            .Columns.Add("sku_category", 0)
            .Columns.Add("cat_remarks", 0)
        End With

        cmd = New SqlCommand("sp_tr_sdelivery_rpt_SEL", cn)
    ...
    Private Sub txtFilter_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtFilter.KeyPress
        If e.KeyChar = Microsoft.VisualBasic.ChrW(Keys.Return) Then
            fdlSDeliveryFrom_Load(sender, e)
        End If
    End Sub
End Class