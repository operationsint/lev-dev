...
Public Class frmPInvoiceList
    ...
    Private Sub frmPInvoiceList_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '20160623 daniel s : enable date filter onload
        chbDate.Checked = True
        dtpPInvoiceDateFrom.Value = Today.AddDays(-GetListDateFilterDays())
        dtpPInvoiceDateTo.Value = Today
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        If Not isDeletedRecord("usp_tr_pinvoice_SEL", "pinvoice_id", LeftSplitUF(ListView1.SelectedItems.Item(0).Tag), Me.Text) = False Then
            btnFilter_Click(sender, e)
        ElseIf Not Application.OpenForms().OfType(Of frmPInvoice).Any Then
            With frmPInvoice
    ...
    'Autorefresh---Hendra
    Public Sub frmPInvoiceListShow(ByVal sender As System.Object, ByVal e As System.EventArgs)
        btnFilter_Click(sender, e)
    End Sub
End Class
