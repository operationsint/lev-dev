...
Public Class fdlStkAdjustmentTo
    ...
    Private Sub fdlStkAdjustmentTo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        With ListView1
            .Clear()
            .View = View.Details
        ...
        Select Case m_FrmCallerId
            Case "rptStkAdjustment"
                With rptStkAdjustment
                    .NoTo = ListView1.SelectedItems.Item(0).SubItems.Item(1).Text
                End With
        End Select
        Me.Close()
    End Sub
    ...
    Private Sub txtFilter_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtFilter.KeyPress
        If e.KeyChar = Microsoft.VisualBasic.ChrW(Keys.Return) Then
            fdlStkAdjustmentTo_Load(sender, e)
        End If
    End Sub
End Class