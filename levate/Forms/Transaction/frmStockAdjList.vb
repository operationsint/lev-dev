...
Public Class frmStockAdjList
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        frmStockAdj.StockAdjId = 0
        frmStockAdj.MdiParent = frmMAIN
        frmStockAdj.Show()
    End Sub
    ...
    Private Sub frmInvoiceList_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '20160620 daniel s : activate date filter on load for performance
    ...
    End Sub
    'Autorefresh---Hendra
    Public Sub frmStockAdjListShow(ByVal sender As System.Object, ByVal e As System.EventArgs)
        btnFilter_Click(sender, e)
    End Sub
End Class