...
Public Class fdlSKUTo
    ...
    Private Sub Cancel_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cancel_Button.Click
        ...
        Me.Close()
    End Sub
    Private Sub fdlSKUTo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        With ListView1
            .Clear()
            .View = View.Details
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        Select Case m_FrmCallerId
            ...
            Case "rptStkMovement"
                With rptStkMovement
                    .StkCodeTo = ListView1.SelectedItems.Item(0).SubItems.Item(1).Text
                End With
            Case "rptStkAdjustment"
                With rptStkAdjustment
                    .SCodeTo = ListView1.SelectedItems.Item(0).SubItems.Item(1).Text
                End With
            Case "rptStkList"
                With rptStkList
                    .StkCodeTo = ListView1.SelectedItems.Item(0).SubItems.Item(1).Text
