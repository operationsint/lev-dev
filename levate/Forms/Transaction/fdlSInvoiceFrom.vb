...
Public Class fdlSInvoiceFrom
    ...
    Private Sub fdlSInvoiceFrom_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        With ListView1
            .Clear()
            .View = View.Details
            .Columns.Add("Sales Invoice No.", 250)
            .Columns.Add("sku_category", 0)
            .Columns.Add("cat_remarks", 0)
        End With

        cmd = New SqlCommand("sp_tr_sinvoice_rpt_SEL", cn)
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        Select Case m_FrmCallerId
            ...
            Case "rptSlsInvoiceSumTo"
                With rptSlsInvoiceSum
                    .SNoTo = ListView1.SelectedItems.Item(0).SubItems.Item(0).Text
                End With
