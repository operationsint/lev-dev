...
Public Class fdlJournal
    ...
    Private Sub fdlJournal_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        With ListView1
            .Clear()
            .View = View.Details
            .Columns.Add("Journal No.", 250)
            .Columns.Add("sku_category", 0)
            .Columns.Add("cat_remarks", 0)
        End With

        cmd = New SqlCommand("sp_tr_journal_rpt_SEL", cn)
        ...
        Select Case m_FrmCallerId
            Case "rptGLJournalTransFrom"
                With rptGLJournalTrans
                    .JournalNoFrom = ListView1.SelectedItems.Item(0).SubItems.Item(0).Text
                End With
            Case "rptGLJournalTransTo"
                With rptGLJournalTrans
                    .JournalNoTo = ListView1.SelectedItems.Item(0).SubItems.Item(0).Text
                End With
