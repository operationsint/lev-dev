...
Public Class fdlExpense
    Private ListView1Sorter As lvColumnSorter
    Dim strConnection As String = My.Settings.ConnStr
    Dim cn As SqlConnection = New SqlConnection(strConnection)
    Dim cmd As SqlCommand
    Dim m_FrmCallerId As String
    Public fdlExpenseMode As Integer '0=Income, 1 = expense, 2 = both
    ...
    Private Sub fdlExpense_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '#RK - 20160209_01 - Enable Income/Expense/Both Code 
        cmbType.Items.Clear()
        cmbType.Items.Add("Income")
        cmbType.Items.Add("Expense")
        If fdlExpenseMode = 1 Or fdlExpenseMode = 2 Then
            cmbType.SelectedIndex = 1
        Else
            cmbType.SelectedIndex = 0
        End If

        If fdlExpenseMode <> 2 Then
