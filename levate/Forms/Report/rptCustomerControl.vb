...
'20160807 daniel s
Public Class rptCustomerControl
    ...
    Private Sub btnPrint_Click(sender As System.Object, e As System.EventArgs) Handles btnPrint.Click
        ...
        If txtSCode.Text.Length = 0 Then
            MessageBox.Show("Please fill Customer Code", "Error")
            Exit Sub
        End If
        ...
        Try
            ...
            cmd = New SqlCommand("exec RPT_CUSTOMER_CONTROL @p1,@p2,@code ", cn)
            ...
            Dim strReportPath As String = Application.StartupPath & "\Reports\RPT_CustomerControl.rpt"
            ...
            NewMDIChild.Text = "Customer Control Report"
            NewMDIChild.Show()
            ...
            filterscode = "Customer Code : " & txtSCode.Text
