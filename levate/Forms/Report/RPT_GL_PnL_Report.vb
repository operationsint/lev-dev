...
Public Class RPT_GL_PnL_Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "levate.RPT_GL_PnL_Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Fromperiod() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Toperiod() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_GL_PnL_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_GL_PnL_Report = New RPT_GL_PnL_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
