...
Public Class rptPRequest
    Private Sub rptPRequest_Load(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        strSQL = "exec RPT_Pch_Request_Report '" & dateFrom1 & "' , '" & dateTo1 & "', '" & pNoFrom1 & "', '" & pNoTo1 & "', '" & sCodeFrom1 & "', '" & sCodeTo1 & "', '" & pchCode1 & "' "
        ...
        Dim strReportPath As String = Application.StartupPath & "\Reports\RPT_Pch_Request_Report.rpt"
        ...
        NewMDIChild.Text = "Purchase Request Report"
        NewMDIChild.Show()

        cr.Load(strReportPath)
        cr.SetDataSource(DS.Tables("PReqRpt_"))
        ...
        If rbAll.Checked = True Then
            ...
            filterpno = "Purchase Request No. : All"
        ...
        Else
            ...
            If txtPNoFrom.Text = "" And txtPNoTo.Text = "" Then
                filterpno = "Purchase Request No. : All"
            Else
                filterpno = "Purchase Request No. : " & txtPNoFrom.Text & " - " & txtPNoTo.Text
            End If
            If txtSCodeFrom.Text = "" And txtSCodeTo.Text = "" Then
                filterscode = "Stock Code : All"
            Else
    ...
    Private Sub btnPNoTo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPNoTo.Click
        Dim NewFormDialog As New fdlPRequestTo
        NewFormDialog.FrmCallerId = Me.Name
        NewFormDialog.ShowDialog()
    End Sub
