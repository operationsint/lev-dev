...
Public Class rptTrialBalanceReport
    ...
    Private Sub rptTrialBalanceReport_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        strSQL = "exec RPT_GL_TrialBalance_Report '" & Period1 & "' , '" & AccountFrom1 & "','" & AccountTo1 & "' , '" & AccCatFrom1 & "', '" & AccCatTo1 & "' "
        ...
        Dim strReportPath As String = Application.StartupPath & "\Reports\RPT_GL_TrialBalance.rpt"
        ...
        NewMDIChild.Text = "Trial Balance"
        NewMDIChild.Show()
        ...
        Dim filter As String = filterperiod + vbCrLf + filteraccountcode + vbCrLf + filteracccatcode
