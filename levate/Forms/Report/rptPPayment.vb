...
Public Class rptPPayment
    Private Sub rptPPayment_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        strSQL = "exec RPT_Pch_Payment_Report '" & dateFrom1 & "' , '" & dateTo1 & "', '" & pNoFrom1 & "', '" & pNoTo1 & "', '" & sCodeFrom1 & "', '" & sCodeTo1 & "' "
        ...
        Dim strReportPath As String = Application.StartupPath & "\Reports\RPT_Pch_Payment_Report.rpt"
        ...
        NewMDIChild.Text = "Purchase Payment Report"
        NewMDIChild.Show()

        cr.Load(strReportPath)
        cr.SetDataSource(DS.Tables("PPayRpt_"))
        ...
        Dim filterdate As String = "Purchase Payment Date : " + dtpFrom.Text + " - " + dtpTo.Text
        Dim filterpno As String
        Dim filterscode As String

        If txtPNoFrom.Text = "" And txtPNoTo.Text = "" Then
            filterpno = "Purchase Payment No : All"
        Else
            filterpno = "Purchase Payment No : " + pNoFrom1 + " - " + pNoTo1
        End If

        If txtSCodeFrom.Text = "" And txtSCodeTo.Text = "" Then
            filterscode = "Supplier Code : All"
        Else
            filterscode = "Supplier Code : " + sCodeFrom1 + " - " + sCodeTo1
        End If
    ...
    Private Sub btnPNoTo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPNoTo.Click
        Dim NewFormDialog As New fdlPPaymentTo
        NewFormDialog.FrmCallerId = Me.Name
        NewFormDialog.ShowDialog()
    End Sub
