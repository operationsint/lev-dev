...
Public Class rptBankExpense

    Private Sub rptBankExpense_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        strSQL = "exec RPT_Bank_Expense_Report '" & Format(dateFrom, "yyyy/MM/dd") & "' , '" & Format(dateTo, "yyyy/MM/dd") & "', " & _
                                                    "'" & BankCodeFrom1 & "', '" & BankCodeTo1 & "', '" & Status & "' "

        Dim DA As New SqlDataAdapter(strSQL, Connection)
        Dim DS As New DataSet

        DA.Fill(DS, "Bank_Expense_Report_")

        Dim strReportPath As String = Application.StartupPath & "\Reports\RPT_Bank_Expense_Report.rpt"
        ...
        NewMDIChild.Text = "Bank Payment Detail Report"
        NewMDIChild.Show()

        cr.Load(strReportPath)
        cr.SetDataSource(DS.Tables("Bank_Expense_Report_"))
