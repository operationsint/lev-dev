...
Public Class rptSlsInvoice
    Private Sub rptSlsInvoice_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        strSQL = "exec RPT_Sls_Invoice_Report '" & dateFrom1 & "' , '" & dateTo1 & "', '" & SNoFrom1 & "', '" & SNoTo1 & "', '" & CCodeFrom1 & "', '" & CCodeTo1 & "', '" & slsCode1 & "', '" & Status & "' "

        Dim DA As New SqlDataAdapter(strSQL, Connection)
        Dim DS As New DataSet

        DA.Fill(DS, "SlsInvoiceRpt_")

        Dim strReportPath As String = Application.StartupPath & "\Reports\RPT_Sls_Invoice_Report.rpt"
        ...
        NewMDIChild.Text = "Sales Invoice Report"
        NewMDIChild.Show()

        cr.Load(strReportPath)
        cr.SetDataSource(DS.Tables("SlsInvoiceRpt_"))
        With NewMDIChild
