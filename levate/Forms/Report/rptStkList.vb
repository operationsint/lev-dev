...
Public Class rptStkList
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Dim strReportPath As String = Application.StartupPath & "\Reports\RPT_Stk_List_Report.rpt"
        ...
        NewMDIChild.Text = "Stock List"
        NewMDIChild.Show()

        cr.Load(strReportPath)
        cr.SetDataSource(DS.Tables("StkList_"))
