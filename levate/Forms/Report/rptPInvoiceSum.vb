...
Public Class rptPInvoiceSum
    Private Sub rptPInvoiceSum_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        strSQL = "exec RPT_Pch_InvoiceSummary_Report '" & dateFrom1 & "' , '" & dateTo1 & "', '" & pNoFrom1 & "', '" & pNoTo1 & "', '" & sCodeFrom1 & "', '" & sCodeTo1 & "', '" & Status & "', '" & pchCode1 & "' "

        Dim DA As New SqlDataAdapter(strSQL, Connection)
        Dim DS As New DataSet

        DA.Fill(DS, "PInvRptSum_")

        Dim strReportPath As String = Application.StartupPath & "\Reports\RPT_Pch_InvoiceSummary_Report.rpt"
        ...
        NewMDIChild.Text = "Purchase Invoice Report Summary"
        NewMDIChild.Show()

        cr.Load(strReportPath)
        cr.SetDataSource(DS.Tables("PInvRptSum_"))
