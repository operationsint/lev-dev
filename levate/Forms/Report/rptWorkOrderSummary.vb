...
Public Class rptWorkOrderSummary

    Private Sub rptWorkOrderSummary_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        strSQL = "exec RPT_Work_Order_Summary_Report '" & dateFrom & "' , '" & dateTo & "', '" & WOFrom1 & "', '" & WOTo1 & "', '" & Status & "' "

        Dim DA As New SqlDataAdapter(strSQL, Connection)
        Dim DS As New DataSet

        DA.Fill(DS, "Work_Order_Summary_Report_")

        Dim strReportPath As String = Application.StartupPath & "\Reports\RPT_Work_Order_Summary_Report.rpt"
        ...
        NewMDIChild.Text = "Work Order Summary Report"
        NewMDIChild.Show()

        cr.Load(strReportPath)
        cr.SetDataSource(DS.Tables("Work_Order_Summary_Report_"))
        ...
        Dim filter As String = filterdate + vbCrLf + filterwono + vbCrLf + filterstatus
