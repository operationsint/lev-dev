...
Public Class RPT_Sup_List_Rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "levate.RPT_Sup_List_Rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Sup_List_Rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Sup_List_Rpt = New RPT_Sup_List_Rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
