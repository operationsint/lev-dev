...
Public Class RPT_Stk_Stock_List
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "levate.RPT_Stk_Stock_List.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Stk_Stock_List
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Stk_Stock_List = New RPT_Stk_Stock_List()
        rpt.Site = Me.Site
        Return rpt
    End Function
