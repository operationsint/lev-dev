...
Public Class RPT_Bank_Adj_Form
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "levate.RPT_Bank_Adj_Form.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_bank_adj_no() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_Bank_Adj_Form
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Bank_Adj_Form = New RPT_Bank_Adj_Form()
        rpt.Site = Me.Site
        Return rpt
    End Function
