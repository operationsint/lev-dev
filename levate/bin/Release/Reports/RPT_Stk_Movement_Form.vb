...
Public Class RPT_Stk_Movement_Form
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_Stk_Movement_Form.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "levate.RPT_Stk_Movement_Form.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_stock_movement_no() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_Stk_Movement_Form
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Stk_Movement_Form = New RPT_Stk_Movement_Form()
        rpt.Site = Me.Site
        Return rpt
    End Function
