...
Public Class docAP
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ap_id() As CrystalDecisions.[Shared].IParameterField
        Get
