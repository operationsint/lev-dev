...
Public Class RPT_GL_TransDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "levate.RPT_GL_TransDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_GL_TransDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_GL_TransDetail = New RPT_GL_TransDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
