...
Public Class RPT_Balance_Sheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "levate.RPT_Balance_Sheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Balance_Sheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Balance_Sheet = New RPT_Balance_Sheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
