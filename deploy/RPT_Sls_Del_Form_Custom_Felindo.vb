...
Public Class RPT_Sls_Del_Form
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "levate.RPT_Sls_Del_Form.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Sls_Del_Form
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Sls_Del_Form = New RPT_Sls_Del_Form()
        rpt.Site = Me.Site
        Return rpt
    End Function
